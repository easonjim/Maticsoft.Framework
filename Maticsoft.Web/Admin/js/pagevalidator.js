...
// 2011-11-16 Ben
// Check设计师
function PageIsValidCheckUser() {
    var isValid = true;
    var validateGroup = "default"; // 默认分组
    var txtSupplierName = "register_reg_Supplier___txtSupplierName";
    var txtDecorationsName = "register_reg_Decoration___txtDecorationsName";

    var ctls = $("[ValidateGroup='" + validateGroup + "']");
    ctls.each(function () {
        if ($("#" + this["id"]).get(0).validator != undefined && $("#" + this["id"]).get(0).validator != null) {
            for (var i = 0; i < $("#" + this["id"]).get(0).validator.length; i++) {
                if (this["id"] == txtSupplierName || this["id"] == txtDecorationsName) {
                    continue;
                }
                if ($("#" + this["id"]).get(0).validator[i].isValid == false) {
                    $("#" + this["id"]).get(0).validator[i].updateShow();
...
// 2011-11-16 Ben
// Check家装公司
function PageIsValidCheckDecorations() {
    var isValid = true;
    var validateGroup = "default"; // 默认分组
    var txtSupplierName = "register_reg_Supplier___txtSupplierName";
...
// 2011-11-16 Ben
// Check供应商
function PageIsValidCheckSupplier() {
    var isValid = true;
    var validateGroup = "default"; // 默认分组
    var txtDecorationsName = "register_reg_Decoration___txtDecorationsName";
