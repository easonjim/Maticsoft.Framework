<%@ Page Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="Maticsoft.Web.Admin.TaoFavorite.Modify" Title="修改页" %>
                    ...
                    <tr>
                        <td align="left">
                            <span style="font-size: 12pt; font-weight: bold; color: #3666AA">
                                ...
                                <asp:Literal ID="Literal1" runat="server" Text="修改收藏夹" /></span>
                        </td>
                        <td align="left">
