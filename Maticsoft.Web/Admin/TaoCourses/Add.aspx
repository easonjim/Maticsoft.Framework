<%@ Page Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true"
    CodeBehind="Add.aspx.cs" Inherits="Maticsoft.Web.Admin.TaoCourses.Add" Title="增加页" %>
                    ...
                    <tr>
                        <td align="left">
                            <span style="font-size: 12pt; font-weight: bold; color: #3666AA">
                                ...
                                <asp:Literal ID="Literal1" runat="server" Text="新增课程" /></span>
                        </td>
                        <td align="middle">
                ...
                <table style="width: 100%" cellspacing="0" cellpadding="0" class="formTableList">
                    ...
                    <tr>
                        ...
                        <td class="rightTD" style="width: 200px" align="left">
                            <asp:DropDownList ID="listTarget" runat="server" Width="286px" CssClass="input_short">
                    ...
                    <tr>
                        ...
                        <td class="rightTD" style="width: 200px" align="left">
                            <asp:FileUpload ID="fileImageUrl" runat="server" Width="286px" />
                        </td>
                        <td class="rightTD">
                            &nbsp;
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="rightTD" style="width: 200px">
                            ...
                            <asp:RegularExpressionValidator ID="revPrince" runat="server" ControlToValidate="txtPrince"
                                ErrorMessage="*格式错误" ValidationExpression="[+-]?\d+$" Display="Dynamic"></asp:RegularExpressionValidator>
                        </td>
                        <td class="rightTD">
                            &nbsp;
