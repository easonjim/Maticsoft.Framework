<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true"
    CodeBehind="AddPaymentMode.aspx.cs" Inherits="Maticsoft.Web.Admin.AddPaymentMode" %>
                            ...
                            <td>
                                <div class="return_inp">
                                    <a href='PaymentModes.aspx'>
                                        <asp:Literal ID="lblReturn" runat="server" Text="<%$ Resources:AddPaymentMode, IDS_FromField_lblReturn %>"></asp:Literal>
                                    </a>
                                </div>
                            </td>
                        </tr>
