<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OffLineCourseInfo.ascx.cs" Inherits="Maticsoft.Web.Controls.OffLineCourseInfo" %>
<%@ Register assembly="AspNetPager" namespace="Wuqi.Webdiyer" tagprefix="webdiyer" %>
<div class="opened2 border3"  <%=display %>>
<div class="bg_lt"></div>
<div class="bg_rt"></div>
<div class="content">
<h3>线下将开课程</h3>
...
<div class="pagess">
    <webdiyer:AspNetPager ID="AspNetPager1" runat="server" CurrentPageButtonPosition="Center"
        ...
        CssClass="page" CurrentPageButtonClass="cpb" HorizontalAlign="Center" PageSize="1"
