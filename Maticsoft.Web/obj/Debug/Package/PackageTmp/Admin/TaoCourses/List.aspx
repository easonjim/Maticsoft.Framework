<%@ Page Title="Tao_Courses" Language="C#" MasterPageFile="~/Admin/Basic.Master"
    AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Maticsoft.Web.Admin.TaoCourses.List" %>
    ...
    <cc1:GridViewEx ID="gridView" runat="server" AllowPaging="True" AllowSorting="True"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="课程章节" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="120px">
                <ItemTemplate>
                    <a href="javascript:;" onclick="View('../TaoModules/List.aspx?CourseID=<%# Eval("CourseID") %>');">
                        查看章节</a>
                </ItemTemplate>
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="顺序" ItemStyle-HorizontalAlign="Right" HeaderStyle-Width="35px">
                <ItemTemplate>
                    <%#Eval("Sequence") %>
                </ItemTemplate>
            </asp:TemplateField>
