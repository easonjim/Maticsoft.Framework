<%@ Page Language="C#" MasterPageFile="~/Admin/Basic.Master" AutoEventWireup="true"
    CodeBehind="Add.aspx.cs" Inherits="Maticsoft.Web.TaoEnterprise.Enterprise.Add" Title="增加页"
                    ...
                    <tr>
                        <td align="left">
                            <span style="font-size: 12pt; font-weight: bold; color: #3666AA">
                                ...
                                <asp:Literal ID="Literal1" runat="server" Text="增加企业" /></span>
                        </td>
                        <td align="left">
                ...
                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                    ...
                    <tr>
                        ...
                        <td height="25" width="*" align="left">
                            ...
                            <asp:RequiredFieldValidator ID="rfvName" runat="server" ErrorMessage="*企业名称不能为空！"
                    ...
                    <tr>
                        ...
                        <td height="25" width="*" align="left">
                            ...
                            <asp:RequiredFieldValidator ID="rfvArtiPerson" runat="server" ErrorMessage="*公司法人不能为空！"
                                ControlToValidate="txtArtiPerson"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td height="25" width="30%" align="right">
