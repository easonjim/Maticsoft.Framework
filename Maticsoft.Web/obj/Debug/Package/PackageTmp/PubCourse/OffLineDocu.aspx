<%@ Page Title="" Language="C#" MasterPageFile="~/PubCourse/PubBasic.Master" AutoEventWireup="true" CodeBehind="OffLineDocu.aspx.cs" Inherits="Maticsoft.Web.PubCourse.OffLineDocu" %>
...
<div class="nav"><a href="">我要教</a> > <strong>线下课程</strong> > <strong>签署协议发布</strong></div>
<h2>签署协议发布</h2>
<div class="padding">
	<div class="agreement">
						<div class="agree" style="margin-top:-25px;">
							...
							<div class="agreeBt" style="margin-top:10px;">
                                        ...
                                        ID="btnPub" runat="server" class="button16" onclick="btnPub_Click"  />
							</div>
						</div>
					</div>
</div>
