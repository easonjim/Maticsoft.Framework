<%@ Page Title="" Language="C#" MasterPageFile="~/NTaoBasic.Master" AutoEventWireup="true" CodeBehind="courselist.aspx.cs" Inherits="Maticsoft.Web.courselist" %>
...
<div class="nav"><strong><a href="courselist.aspx">全部课程</a></strong> <%=strSiteNav%></div>
<h2>课程列表</h2>
<div class="padding">
<div class="select">
...
<img src="imagesN/TLaoShi_bg098_1.gif" width="172" height="72" />
<%--
<div class="search">
