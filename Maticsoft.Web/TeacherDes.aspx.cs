...
{
    public partial class TeacherDes : PageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.ucOffLineCourseInfo.UID = UID;
            this.ucOffLineCourseInfo.Type = 1;
            this.ucOffLineCourseInfo.DataBind();
            this.ucOffLineCourseInfo1.UID = UID;
            this.ucOffLineCourseInfo1.Type = 0;
            this.ucOffLineCourseInfo1.DataBind();
        }
        ...
        private void InitData(int uid)
        {
            ...
            if (null != ds && 0 != ds.Tables.Count && 0 != ds.Tables[0].Rows.Count && 0 != ds.Tables[0].Columns.Count)
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    if (string.IsNullOrEmpty(dr["TrueName"].ToString()))
                    {
                        this.litName.Text = dr["UserName"].ToString();
                    }
                    else
                    {
