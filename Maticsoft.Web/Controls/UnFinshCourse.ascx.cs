...
{
    public partial class UnPublishCourse : System.Web.UI.UserControl
    {
        ...
        {
            AspNetPager1.RecordCount = courseBll.unPublishCount(UserId, Status);
            BoundDate();
        }

        private void BoundDate()
        {
            System.Data.DataSet ds = courseBll.unPublishCourseInfo(UserId, AspNetPager1.StartRecordIndex, AspNetPager1.PageSize, Status);
        ...
        protected void Repeater_PubCourse_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            {
                Response.Redirect("/PubCourse/NewPubCourse.aspx?CourseId=" + labCid.Text);
            }
        }
