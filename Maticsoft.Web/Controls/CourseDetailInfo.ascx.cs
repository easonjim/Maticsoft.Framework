...
{
    public partial class CourseDetailInfo : System.Web.UI.UserControl
    {
        BLL.Tao.Courses courseBll = new BLL.Tao.Courses();

        public override void DataBind()
        {
            AspNetPager1.RecordCount = courseBll.PublishCourseCount(UserID, 3, 0);
            BindData(LimiteDate);
        }

        private void BindData(string Limitdate)
        {
            DataSet ds = courseBll.GetPubLishCourse(UserID, AspNetPager1.StartRecordIndex, AspNetPager1.PageSize, 3, 0);
