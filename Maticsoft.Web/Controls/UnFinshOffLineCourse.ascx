<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UnFinshOffLineCourse.ascx.cs" Inherits="Maticsoft.Web.Controls.UnFinshOffLineCourse" %>
		...
		<tr>
			...
			<td align="center" valign="middle" class="b2">
                <asp:Label ID="labCID" runat="server" Text='<%#Eval("CourseID") %>' Visible="false" ></asp:Label>
                    ...
                    <%#Eval("BookCount")%></td>
			<td align="center" valign="middle" ><%#Eval("CoursePrice", "{0:C}")%></td>
