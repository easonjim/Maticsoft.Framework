<%@ Page Title="" Language="C#" MasterPageFile="~/PubCourse/PubBasic.Master" AutoEventWireup="true" CodeBehind="OnlineCourse.aspx.cs" Inherits="Maticsoft.Web.PubCourse.OnlineCourse" EnableEventValidation="false" EnableViewState="false"   %>
...
<div class="nav"><a href="">我要教</a> > <strong>课程管理</strong> > <strong>已开课程</strong></div>
<h2>已开课程</h2>
...
<ItemTemplate>
<tr>
<td align="center" valign="middle" class="b1" ><a href="../PreviewVideo.aspx?id=<%# Eval("CourseID") %>" title='<%#Eval("CourseName")%>'><%# string.IsNullOrEmpty(Eval("ImageUrl").ToString()) ? "<img src='../images/pics/none.gif' style=\"width:90px;height:70px;\"/>" : "<img src=\"" + Eval("ImageUrl").ToString() + "\" style=\" height:70px;width:90px\"/>"%></a></td>
<td align="left" valign="middle" style="width:100px;"><a href="../PreviewVideo.aspx?id=<%# Eval("CourseID") %>" title='<%#Eval("CourseName")%>'  style="color:#004986;" ><%#HttpUtility.HtmlEncode(Eval("CourseName").ToString())%><br /></a></td>
...
<ContentTemplate>
<uc:UnFinshCourse ID="UnFinshCourse1" runat="server" />
</ContentTemplate>
</asp:UpdatePanel>
</div>
