...
namespace Maticsoft.Common
{
    ...
    {
        private static Maticsoft.DBUtility.DbHelperSQLP sqlhelp = new Maticsoft.DBUtility.DbHelperSQLP(Maticsoft.DBUtility.PubConstant.GetConnectionString("ConnectionString"));
